...
export default function Home() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#0a0a0a]" style={{ fontFamily: "Arial, sans-serif" }}>
      {/* Top nav */}
      ...
      <main className="flex flex-col items-center justify-center flex-1 px-4" style={{ marginTop: "-80px" }}>
        ...
        <form onSubmit={handleSearch} className="w-full max-w-[584px] mt-8">
          <div
            className={`flex items-center gap-3 px-4 py-3 rounded-full border transition-all bg-[#111] ${
              focused
                ? "border-[#00e5ff] shadow-[0_0_14px_rgba(0,229,255,0.45)]"
                : "border-[#2a2a2a] hover:border-[#00e5ff] hover:shadow-[0_0_10px_rgba(0,229,255,0.25)]"
            }`}
          >
            <SearchIcon />
            <input
              ...
              className="flex-1 text-base outline-none text-[#e0e0e0] bg-transparent placeholder-[#444]"
            ...
            <button type="button" className="hover:bg-[#1a1a1a] rounded-full p-1 transition-colors" aria-label="Search by voice">
              <MicIcon />
            </button>
          </div>
          ...
          <div className="flex items-center justify-center gap-3 mt-7">
            <button
              ...
              style={{ color: "#00e5ff", background: "#111", borderColor: "#2a2a2a" }}
              onMouseEnter={(e) => {
      ...
      {/* Footer */}
      <footer className="bg-[#0d0d0d] border-t border-[#1a1a1a] text-sm text-[#555]">
